...
export class AccountComponent {
  ...
  load(): void {
    ...
    forkJoin({
      addresses: this.accountApi.myAddresses(),
      favorites: this.catalogApi.favorites(),
      branches: this.branchApi.branches(),
    })
  ...
  saveAddress(): void {
    ...
    const request = this.editingAddressId()
      ? this.accountApi.updateAddress(this.editingAddressId()!, payload)
